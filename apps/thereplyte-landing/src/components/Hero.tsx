  ...
  return (
    <section className="relative overflow-hidden pb-16 pt-32 md:pb-24 md:pt-40">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute -top-40 left-1/4 h-96 w-96 rounded-full bg-indigo-brand/15 blur-[140px]" />
        <div className="absolute right-1/4 top-20 h-80 w-80 rounded-full bg-teal-brand/10 blur-[130px]" />
      </div>
        ...
        <div>
          ...
          >
            <a
              ...
              className="btn-gradient inline-flex items-center gap-2.5 rounded-full px-7 py-3.5 text-sm font-semibold text-night"
            >
            ...
            <a
              href="#how"
              className="glass inline-flex items-center gap-2 rounded-full px-7 py-3.5 text-sm font-semibold text-slate-200 transition-colors hover:border-white/20 hover:text-white"
            >
              See how it works
