  ...
  return (
    <section className="relative py-24 md:py-32">
      <div className="mx-auto max-w-5xl px-5">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl border border-white/10 px-8 py-16 text-center md:py-24">
            {/* Glow backdrop */}
            <div aria-hidden className="absolute inset-0">
              <div className="absolute -left-24 top-0 h-72 w-72 rounded-full bg-teal-brand/20 blur-[110px]" />
              <div className="absolute -right-24 bottom-0 h-72 w-72 rounded-full bg-indigo-brand/25 blur-[110px]" />
              <div
            ...
            <div className="relative">
              ...
              <a
                ...
                className="btn-gradient mt-9 inline-flex items-center gap-2.5 rounded-full px-8 py-4 text-sm font-semibold text-night"
              >
