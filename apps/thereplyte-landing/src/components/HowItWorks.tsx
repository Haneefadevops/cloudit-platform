            ...
            <Reveal key={s.n} delay={i * 0.12}>
              <div className="relative">
                ...
                <div className="flex flex-col items-center text-center">
                  <span className="flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-gradient text-lg font-extrabold text-white shadow-[0_8px_24px_-6px_rgba(0,216,199,0.5)]">
                    {s.n}
                  </span>
                  <h3 className="mt-6 text-xl font-semibold text-[#12142b]">{s.title}</h3>
                  <p className="mt-3 max-w-xs text-sm leading-relaxed text-[#5a5e7a]">{s.copy}</p>
                </div>
              </div>
            </Reveal>
          ))}
