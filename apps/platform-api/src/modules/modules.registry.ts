...
export const PRODUCT_REGISTRY: ProductDefinition[] = [
    ...
    modules: [
      {
        key: 'properties',
        label: 'Properties',
        description: 'Hotels and guesthouses',
      },
  ...
  },
  {
    ...
    label: 'NotchMe',
    description:
      'Professional identity, relationship management, and booking workspace',
    modules: [
      {
        key: 'crm',
        label: 'CRM',
        description: 'Relationship and customer management',
      },
      {
        key: 'scheduling',
        label: 'Scheduling',
        description: 'Availability, meeting types, and bookings',
      },
      {
        key: 'analytics',
        label: 'Analytics',
        description: 'Profile and workspace analytics',
      },
      {
        key: 'ratings',
        label: 'Ratings',
        description: 'Feedback and ratings management',
      },
      {
        key: 'business_accounts',
        label: 'Business Accounts',
        description: 'Business account and relationship management',
      },
    ],
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        description: 'Live attendance dashboard',
      },
      {
        key: 'spoofing_review',
        label: 'Spoofing Review',
        description: 'Attendance spoofing review',
      },
      ...
      { key: 'calendar', label: 'Calendar', description: 'Team calendar' },
      {
        key: 'corrections',
        label: 'Corrections',
        description: 'Attendance corrections',
      },
      ...
      },
      {
        key: 'geofences',
        label: 'Geofences',
        description: 'Location-based check-in boundaries',
      },
      {
        key: 'reports',
        label: 'Reports',
      ...
      },
      {
        key: 'kiosk',
        label: 'Kiosk',
        description: 'Self-service attendance kiosk',
      },
    ],
  },
];
