...
const routes: Record<string, string> = {
  ...
  salary_revised: '/profile',
  training_assigned: '/training',
  payroll_finalized: '/payslips',
...
export default function NotificationsPage() {
  ...
  return (
    <EmployeeLayout showGreeting={false} title="Notifications" hideHeader>
      <div className="flex flex-col min-h-screen bg-[#F8F7F9] font-['Plus_Jakarta_Sans'] pb-24">
        
        {/* Purple Header */}
        <div className="bg-[#1E1854] px-4 pt-4 pb-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-extrabold text-lg">Notifications</span>
            </div>
            ...
            notifications.map(n => {
              ...
              return (
                <div
                  ...
                  className={`flex gap-3 px-4 py-3 cursor-pointer transition-colors ${n.read ? 'bg-transparent' : 'bg-white'} border-b border-[#F1F0F4]`}
