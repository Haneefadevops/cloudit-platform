...
const navItems = [
  ...
  { to: "/dashboard/customers", icon: Users, label: "People" },
  { to: "/dashboard/scheduling", icon: CalendarClock, label: "Calendar" },
  { to: "/dashboard/profile", icon: User, label: "My Page" },
  { to: "/dashboard/analytics", icon: TrendingUp, label: "Insights" },
];
...
const workspaceItems = [
  ...
  { to: "/dashboard/organization", icon: Building2, label: "Workspace" },
  {
  ...
  { to: "/dashboard/upgrade", icon: Zap, label: "Plans" },
...
function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <aside
        className={cn(
          "fixed left-0 top-16 z-40 flex h-[calc(100vh-4rem)] w-72 transform flex-col border-r border-border bg-background/95 backdrop-blur-xl transition-transform md:static md:top-0 md:h-auto md:min-h-screen md:w-72 md:translate-x-0",
