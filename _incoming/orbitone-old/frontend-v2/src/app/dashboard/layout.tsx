...
const navItems = [
  ...
  { to: "/dashboard/accounts", icon: Briefcase, label: "Accounts", businessOnly: true },
  { to: "/dashboard/organization", icon: Building2, label: "Organization" },
  { to: "/dashboard/organization/members", icon: UserCog, label: "Team", adminOnly: true },
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <div className="flex h-16 shrink-0 items-center justify-between border-b border-border/50 bg-surface/60 px-4 backdrop-blur-xl md:hidden">
        ...
        <div className="flex items-center gap-2">
          <ThemeToggle />
          <Button variant="ghost" size="sm" className="h-9 w-9 px-0" onClick={() => setMobileOpen((open) => !open)} aria-label="Toggle menu">
