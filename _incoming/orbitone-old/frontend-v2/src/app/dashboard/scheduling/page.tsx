          ...
          {publicBookingUrl ? (
            ...
            <>
              ...
              <Button size="sm" asChild>
                <Link to="/dashboard/profile">Publish profile</Link>
              </Button>
            </>
          )}
        </CardContent>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <Button size="sm" variant="outline" className="mt-4 w-full" asChild>
              <Link to="/dashboard/scheduling/meeting-types">Manage</Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Button size="sm" variant="outline" className="mt-4 w-full" asChild>
              <Link to="/dashboard/scheduling/availability">Set availability</Link>
            </Button>
          </CardContent>
        </Card>
