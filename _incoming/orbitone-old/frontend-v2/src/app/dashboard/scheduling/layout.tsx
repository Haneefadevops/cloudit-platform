...
import { LayoutDashboard, List, Clock, Settings, CalendarDays } from "lucide-react";
import { cn } from "@/lib/utils";

const subNavItems = [
  { to: "/dashboard/scheduling", icon: LayoutDashboard, label: "Overview", exact: true },
  { to: "/dashboard/scheduling/calendar", icon: CalendarDays, label: "Calendar", exact: true },
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-muted">Manage your availability, meeting types, and bookings.</p>
      </div>
